        ...
        <div className="md:w-2/3 w-4/5">
          ...
          <div className="mt-6 border-b-2 py-6">
            ...
            <div className="flex flex-col items-center">
                ...
                <span className="flex Poppitandfinchsans text-5xl text-white items-center bg-grey-lighter rounded rounded-r-none my-4 ">TOTAL SLUGGIES MINTED:  <span className="text-blau text-6xl"> {!signedIn ?  <>-</>  :  <>{totalSupply}</> } / 5500</span></span>
                ...
                <div id="mint" className="flex justify-around  mt-8 mx-6">
                  ...
                  <span className="flex Poppitandfinchsans text-5xl text-white items-center bg-grey-lighter rounded rounded-r-none px-3 font-bold">SLUGGIES!</span>
