        ...
        <div className="md:w-2/3 w-4/5">
          ...
          <div className="mt-6 border-b-2 py-6">
            ...
            <div className="flex flex-col items-center">
              ...
              <a href = "mailto:taylormadenft@gmail.com?subject = SluggieSupport&body = Support Message" className="button amatic text-4xl hover:text-green-400"><i class="fad fa-envelope-open-text fa-lg"></i>Request Support</a>                
            </div> 
            </div>
